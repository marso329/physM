...
temp_cube.set_solid()
temp_cube.change_position(0, 0, 4)
temp_cube.change_velocity(0, 0, -2)
temp_cube.change_angular_velocity(-50, 0, 0)

temp_cube1=cube.cube(1,1,1,"BLUE")
temp_cube1.set_solid()
temp_cube1.change_position(0, 0, 0)
temp_cube1.change_velocity(0, 0, 2)
temp_cube1.change_angular_velocity(50, 0, 0)
